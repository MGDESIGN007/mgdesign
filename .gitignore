...
echo "<pre>------------------------Setup by MGDesign------------------------</pre>" > /home/vps/public_html/index.html
...
useradd -M -s /bin/false MGDesign
echo "MGDesign:$PASS" | chpasswd
echo "MGDesign" > pass.txt
echo "$PASS" >> pass.txt
...
# info
clear
echo "------------------------Setup by MGDesign------------------------" | tee log-install.txt
...
echo "---------------"  | tee -a log-install.txt
echo "User     : MGDesign"  | tee -a log-install.txt
